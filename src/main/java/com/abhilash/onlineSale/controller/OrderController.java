...
public class OrderController {
    ...
    @Autowired
    OrderController(ProductService productService, CartServices cartServices, MyOrdersServices myOrdersServices, OrderDetailsServices orderDetailsServices) {
    ...
    public String addItemToCart(@RequestParam("id") Integer productId, @ModelAttribute("currentUser") UserForm userForm) {
    ...
    public String increaseQtyByOne(@RequestParam("productId") Integer productId, @ModelAttribute("currentUser") UserForm userForm) {
    ...
    public String decreaseQtyByOne(@RequestParam("productId") Integer productId, @ModelAttribute("currentUser") UserForm userForm) {
    ...
    public String deleteProduct(@RequestParam("productId") Integer productId, @ModelAttribute("currentUser") UserForm userForm) {
    ...
    /**
     * WE ARE SELECTING THE PRODUCT FROM THE CART , ADDING THEM IN MYORDER , WHICH GENERATE THE ORDER ID
    ...
    //PLACE THE ORDER ||  COPY THE PRODUCT FROM CART TO MYORDER AND DELETE THEM FROM CART
    ...
    public String placeOrder(@ModelAttribute("currentUser") UserForm userForm, Model model) {
        ...
        List<OrderDetails> afterSaveOrderDetails = orderDetailsServices.saveOrderDetails(userForm.getUserId(), myOrders);
    ...
    public String cancelOrder(@RequestParam("id") Integer orderDetailsId) {
        ...
        // IF NOT CANCELED OR NOT DELIVERED THEN CANCEL THE ORDER , UPDATE THE ORDER AMOUNT AND ORDER QTY IN MYORDER TABLE
    ...
    public String updateOrderStatus(@RequestParam("orderDetailsId") Integer orderDetailsId, @RequestParam("newStatus") String newStatus) {
    ...
    public String cancelQtyOrderStatus(@RequestParam("orderDetailsId") Integer orderDetailsId, @RequestParam("newQty") Long newQty) {
